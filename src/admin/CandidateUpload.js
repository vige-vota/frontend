    	...
    	return (
     		<FormattedMessage
                ...
                defaultMessage= 'Maximum dimension is {0}.'>
	    					{(invalidFileSizeMessageDetail) => fileUpload = <FileUpload accept={this.props.accept} maxFileSize={this.props.maxFileSize}
     							chooseLabel={this.props.chooseLabel} previewWidth={this.props.previewWidth} emptyTemplate={this.emptyTemplate}
     							invalidFileSizeMessageSummary='' invalidFileSizeMessageDetail={invalidFileSizeMessageDetail + ''} />}
	    	</FormattedMessage>
    	)
  	}
}